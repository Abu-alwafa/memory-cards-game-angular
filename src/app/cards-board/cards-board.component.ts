...
const startSound = new Audio('/src/assets/start.wav')
const matchSound = new Audio('/src/assets/good-6081.mp3')
const failSound = new Audio('/src/assets/negative_beeps-6008.mp3')
@Component({
